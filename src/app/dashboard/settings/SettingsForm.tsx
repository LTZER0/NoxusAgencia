              ...
              <div className="flex gap-4">
                <div className="flex-1 max-w-[150px]">
                  ...
                  <input
                    ...
                    className="mt-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-purple-800 sm:text-sm sm:leading-6"
                  />
                </div>
                <div className="flex-1 max-w-[150px]">
            ...
            <div className="sm:col-span-4">
              ...
              <div className="mt-2 flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-purple-800 sm:max-w-md">
                ...
                <input
                  ...
                  className="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6 font-mono text-purple-800 font-medium"
                  placeholder="minha-lanchonete"
                />
              </div>
